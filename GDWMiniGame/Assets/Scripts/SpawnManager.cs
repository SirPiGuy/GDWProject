...
public class SpawnManager : MonoBehaviour
{
    ...
    void SpawnRandomEnemy()
    {
        ...
        if (spawnPosition == 0)
        {
            ...
            Instantiate(enemyPrefabs[enemyIndex], spawnPos, Quaternion.Euler(0, 180, 0));
        }
        if (spawnPosition == 1)
        {
            ...
            Instantiate(enemyPrefabs[enemyIndex], spawnPos, Quaternion.Euler(0, -90, 0));
        }
        if (spawnPosition == 2)
        {
            ...
            Instantiate(enemyPrefabs[enemyIndex], spawnPos, Quaternion.Euler(0, 0, 0));
        }
        if (spawnPosition == 3)
        {
